 ...
 * (NIP-44 vs NIP-04). Portado de Luna Negra: el `BunkerSigner` de nostr-tools solo
 * habla NIP-44, y eso rompe contra firmantes como Amber/Primal que por defecto usan
 * NIP-04 (la respuesta `connect` nunca se descifra y el login "aprueba y no pasa
 * nada"). Este cliente prueba ambos y fija el que funciona.
 */

import { finalizeEvent, getPublicKey, nip04, nip44, type Event } from "nostr-tools";
import { SimplePool, type SubCloser } from "nostr-tools/pool";
import type { UnsignedEvent } from "./signer-core.js";
